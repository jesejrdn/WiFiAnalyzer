...
public enum NavigationMenu {
    ...
    SENDFILE(R.drawable.ic_settings_grey_500_48dp,"Send File",NavigationItemFactory.SENDFILE),
    RECVFILE(R.drawable.ic_settings_grey_500_48dp, "Recieve File", NavigationItemFactory.RECVFILE),
