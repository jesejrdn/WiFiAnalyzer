...
public enum NavigationMenu {
    ...
    SENDFILE(R.drawable.ic_settings_grey_500_48dp,R.string.action_receive,NavigationItemFactory.SENDFILE),
    RECVFILE(R.drawable.ic_settings_grey_500_48dp, R.string.action_send, NavigationItemFactory.RECVFILE),
